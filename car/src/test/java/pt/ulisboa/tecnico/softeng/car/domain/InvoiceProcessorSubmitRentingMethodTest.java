...
public class InvoiceProcessorSubmitRentingMethodTest {
	...
	public void setUp() {
		...
		this.car = new Car(PLATE, KILOMETERS, AMOUNT, this.rentacar);
		this.renting = car.rent(DRIVING_LICENSE, DATE1, DATE2, NIF2, IBAN2);
	}
	...
	public void oneTaxFailureOnSubmitInvoice(@Mocked final TaxInterface taxInterface,
		...
		this.rentacar.getProcessor().submitRenting(this.renting);
		this.rentacar.getProcessor().submitRenting(new Renting(DRIVING_LICENSE, DATE1, DATE2, car, NIF2, IBAN2));
