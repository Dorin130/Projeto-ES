...
public class IRSGetInvoiceByReferenceTest {
	...
	@Test
	public void success() {
		assertEquals(this.invoice, this.irs.getInvoiceByReference(this.invoice.getReference()));
	}

	@Test(expected = TaxException.class)
	public void nullReference() {
		this.irs.getInvoiceByReference(null);
	}

	@Test(expected = TaxException.class)
	public void emptyReference() {
		this.irs.getInvoiceByReference("");
	}

	@Test
	public void doesNotExist() {
		assertNull(this.irs.getInvoiceByReference(BUYER_NIF));
	}
