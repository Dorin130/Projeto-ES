...
public class ClientController {
	...
	public String submitClient(Model model, @PathVariable String brokerCode,
		...
		logger.info("clientSubmit brokerCode:{}, nif:{}, age:{}, iban:{}, drivingLicense:{}", brokerCode,
				clientData.getNif(), clientData.getAge(), clientData.getIban(),
				clientData.getDrivingLicense());
